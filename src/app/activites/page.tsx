        ...
        <section className="grid items-start gap-10 lg:grid-cols-[0.95fr_1.05fr]">
          <div className="space-y-10">
            <div className="rounded-3xl border border-zinc-200 bg-white p-6 shadow-sm">
              ...
              <div className="mt-4 space-y-4 text-base leading-7 text-zinc-600">
                <p>
                  ...
                  environ 20 jeunes de 10 à 17 ans (dans la limite des places
                  disponibles). Nos éducateurs diplômés FFC forment les jeunes
                  aux bases du pilotage, de la sécurité et de la compétition.
                </p>
                ...
                <div className="grid gap-4 lg:grid-cols-2">
                  <div className="rounded-2xl bg-zinc-50 p-4">
                    ...
                    <ul className="space-y-2 text-sm">
                      <li>
                        • <strong>Âge :</strong> 10 à 17 ans
                      </li>
                      <li>
                        • <strong>Effectif :</strong> ~20 jeunes par saison
                      </li>
                      <li>
                        • <strong>Formation :</strong> Pilotage, sécurité,
                        compétition
                      </li>
                      <li>
                        • <strong>Éducateurs :</strong> Diplômés FFC
                      </li>
                      <li>
                        • <strong>Organisation :</strong> Semaine paire séance orientée
                        technique, semaine impaire séance orientée compétition
                      </li>
                    </ul>
                  </div>

                  <div className="rounded-2xl bg-zinc-50 p-4">
                    <h3 className="mb-2 font-semibold text-zinc-900">Objectifs</h3>
                    <ul className="space-y-2 text-sm">
                      <li>• Développer la maîtrise du VTT en sécurité</li>
                      <li>• Apprendre les bases du pilotage en terrain varié</li>
                      <li>
                        • Construire l&apos;esprit d&apos;équipe et l&apos;autonomie
                      </li>
                  ...
                  <div className="rounded-2xl bg-blue-50 p-4 lg:col-span-2">
                    <h3 className="mb-2 font-semibold text-blue-900">Stages</h3>
                ...
                <p className="text-sm">
                  Les entraînements ont lieu régulièrement et permettent aux
                  jeunes de progresser dans un cadre sécurisé et bienveillant.
                </p>
              </div>
            </div>
            ...
            <div className="rounded-3xl border border-zinc-200 bg-white p-6 shadow-sm">
              ...
              <div className="mt-4 space-y-4 text-base leading-7 text-zinc-600">
                <p>
                  Nouvelle école de cyclisme sur route pour les jeunes à partir
                  de 11 ans. Cette école fait partie des projets 2025 du club et
            ...
            <div className="mt-4 space-y-4 text-base leading-7 text-zinc-600">
              ...
              <div className="grid gap-4 lg:grid-cols-2">
                <div className="rounded-2xl bg-zinc-50 p-4">
                  ...
                  <ul className="space-y-2 text-sm">
                    <li>
                      • <strong>Fréquence :</strong> Sorties hebdomadaires
                    </li>
                    <li>
                      • <strong>Groupes :</strong> Niveaux adaptés
                    </li>
                    <li>
                      • <strong>Encadrement :</strong> Éducateurs diplômés - Voiture-balai
                    </li>
                    <li>
                      • <strong>Parcours :</strong> Variés selon les saisons
                    </li>
                  </ul>
                </div>
                ...
                <div className="rounded-2xl bg-blue-50 p-4 lg:col-span-2">
                  ...
                  <p className="mb-3 text-sm text-blue-800">
                    ...
                    permettant aux coureurs de s&apos;entraîner dans des conditions
                    optimales et de progresser ensemble.
                  </p>
              ...
              <p className="text-sm">
                Les sorties sont l&apos;occasion de partager la passion du cyclisme,
                de progresser ensemble et de préparer les compétitions dans une
